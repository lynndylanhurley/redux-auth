...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "SignOutLink", {
	  enumerable: true,
	  get: function get() {
	    return _default.SignOutLink;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRouterRedux = __webpack_require__(142);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcDialog = __webpack_require__(141);

	var _rcDialog2 = _interopRequireDefault(_rcDialog);

	var _ErrorList = __webpack_require__(88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsCookie = __webpack_require__(139);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handleFetchResponse = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function applyConfig() {
	  ...
	  if ((0, _sessionStorage.getCurrentSettings)().initialCredentials) {
	    ...
	    return (0, _fetch2.default)((0, _sessionStorage.getTokenValidationPath)('default')).then(_handleFetchResponse.parseResponse).then(function (_ref2) {
	      var data = _ref2.data;
	...
	var EmailSignInForm = function (_React$Component) {
	  ...
	  _createClass(EmailSignInForm, [{
	    ...
	    value: function render() {
	      ...
	      var loading = this.props.auth.getIn(["emailSignIn", this.getEndpoint(), "loading"]);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            loading ? _react2.default.createElement("div", { "class": "button-spinner small simple" }) : null,
	            _react2.default.createElement(
	              "span",
	              { "class": "button-text" },
	              "Login"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SignOutLink = function (_React$Component) {
	  _inherits(SignOutLink, _React$Component);

	  function SignOutLink() {
	    _classCallCheck(this, SignOutLink);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SignOutLink).apply(this, arguments));
	  }

	  _createClass(SignOutLink, [{
	    key: "getEndpoint",
	    value: function getEndpoint() {
	      return this.props.endpoint || this.props.auth.getIn(["configure", "currentEndpointKey"]) || this.props.auth.getIn(["configure", "defaultEndpointKey"]);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ButtonLoader = exports.TokenBridge = exports.DestroyAccountButton = exports.UpdatePasswordForm = exports.OAuthSignInButton = exports.RequestPasswordResetForm = exports.SignOutLink = exports.SignOutButton = exports.EmailSignUpForm = exports.EmailSignInForm = exports.AuthGlobals = undefined;

	var _AuthGlobals2 = __webpack_require__(84);

	var _AuthGlobals3 = _interopRequireDefault(_AuthGlobals2);

	var _EmailSignInForm2 = __webpack_require__(86);

	var _EmailSignInForm3 = _interopRequireDefault(_EmailSignInForm2);

	var _EmailSignUpForm2 = __webpack_require__(87);

	var _EmailSignUpForm3 = _interopRequireDefault(_EmailSignUpForm2);

	var _SignOutButton2 = __webpack_require__(91);

	var _SignOutButton3 = _interopRequireDefault(_SignOutButton2);

	var _SignOutLink2 = __webpack_require__(92);

	var _SignOutLink3 = _interopRequireDefault(_SignOutLink2);

	var _RequestPasswordResetForm2 = __webpack_require__(90);

	var _RequestPasswordResetForm3 = _interopRequireDefault(_RequestPasswordResetForm2);

	var _OAuthSignInButton2 = __webpack_require__(89);

	var _OAuthSignInButton3 = _interopRequireDefault(_OAuthSignInButton2);

	var _UpdatePasswordForm2 = __webpack_require__(93);

	var _UpdatePasswordForm3 = _interopRequireDefault(_UpdatePasswordForm2);

	var _DestroyAccountButton2 = __webpack_require__(85);
	...
	exports.SignOutLink = _SignOutLink3.default;
